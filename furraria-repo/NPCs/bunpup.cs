...
namespace FurrariaMod.NPCs 
{
    ...
    public class bunpup : ModNPC
    {
        ...
        private void Shoot()
        {
            int type = mod.ProjectileType("BunPupBeam");
        ...
        public override void NPCLoot()
        {
            ...
            } else
            {
                ...
                {
                    Item.NewItem((int)npc.position.X, (int)npc.position.Y, npc.width, npc.height, mod.ItemType("FunPup"));
                }
