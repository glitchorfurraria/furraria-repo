...
namespace FurrariaMod.Blocks
{
    public class DecorellOreTile : ModTile
    {
        public override void SetDefaults()
        {
            ...
            drop = mod.ItemType("DecorellOre"); // What item drops after destorying the tile
            ModTranslation name = CreateMapEntryName();
            name.SetDefault("Decorell Ore");
